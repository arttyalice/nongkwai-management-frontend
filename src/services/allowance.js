...
export default {
    ...
    async getAllPersonWithTypeAndAllowanceReport (from, to, type, allowance) {
        let res = await apiService.get(`/allowance/get/report?from=${from}&to=${to}&type=${type}&allowance=${allowance}`)
        return res.data
    },
